...
namespace Open_Schooling.Models
{
    public class Foreign_Model
    {
        ...
        [Required(ErrorMessage = " required.....")]
        [DataType(DataType.Text)]
        [RegularExpression("^[a-zA-Z_ ]*$", ErrorMessage = "Not a valid Place ")]
        ...
        [Required(ErrorMessage = "Regular school Name required.....")]
        [DataType(DataType.Text)]
        public string Regular_school_Name { get; set; }
        [Required(ErrorMessage = "School Address required.....")]
        [DataType(DataType.Text)]
